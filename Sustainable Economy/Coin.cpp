...
Coin::Coin(int start_x, int start_y, int end_x, int end_y) : Entity(start_x, start_y), moving(true), speed(12), height(0)
{ 
...
void Coin::CalcInitPlanar(void)
{
	//Randomise the angle of initial trajectory.
			//angle = (rand() % 55) + 10; //Angle between 10 and 65 degrees
			angle = 75;
