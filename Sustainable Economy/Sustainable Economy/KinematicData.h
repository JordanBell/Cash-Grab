...
struct KinematicData 
{
	...
	void SetVelocityFromScalar(float speed)
	{
		velocity.x = speed * cos(angle);
		velocity.y = speed * sin(angle);
	}

	// Set the angle, in radians, based on a suppression value
	void SetAngleBySuppression(int angleSuppression) 
...
private:
	...
	static const float ComputeAngleBySuppression(int angleSuppression);
